...
namespace Operations
{
    public class Operation
    {
        ...
        public static void StartOperations(TcpClient.WcfSiplexService.WcfSiplexClient client)
        {
            Console.WriteLine("\nChoose method:");
            ...
            switch (chooseMethod)
            {
                ...
                case 3:
                    ...
                    var sumResult = client.Sum(new TcpClient.WcfSiplexService.A { F = f, K = k, S = s }, new TcpClient.WcfSiplexService.A { F = f1, K = k1, S = s1 });
