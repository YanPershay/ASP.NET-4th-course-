...
namespace Operations
{
    public class Operation
    {
        ...
        public static void StartOperations(HttpClient.WcfSiplexService.WcfSiplexClient client)
        {
            Console.WriteLine("\nChoose method:");
            ...
            switch (chooseMethod)
            {
                ...
                case 3:
                    ...
                    var sumResult = client.Sum(new WcfSiplex.A { F = f, K = k, S = s }, new WcfSiplex.A { F = f1, K = k1, S = s1 });
